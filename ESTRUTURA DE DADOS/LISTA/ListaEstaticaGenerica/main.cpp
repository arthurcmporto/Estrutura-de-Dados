...
void exibirMenu() {
    ...
    cout << "3. Verificar se ha espaco na lista" << endl;
...
int main() {
    const int MAX = 10; // Defina o tamanho máximo da lista
    ...
    do {
        ...
        switch (opcao) {
            ...
            case 2:
                ...
                break;
            case 3:
                cout << (temEspaco(lista) ? "A lista tem espaço disponivel." : "A lista está cheia.") << endl;
                break;
            case 4:
